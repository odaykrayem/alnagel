...
class pyamntnotdone extends StatefulWidget {
  @override
  _pyamntnotdoneState createState() => _pyamntnotdoneState();
}

class _pyamntnotdoneState extends State<pyamntnotdone> {
  @override
                                      ...
                                      children: [
                                        ...
                                        Container(height: 25,width: 93,
                                          child: FlatButton(color:Colors.red
                                            ,child: Text('NotPaid'.tr,style: TextStyle(fontSize: 10,color: Colors.white)),
                                            onPressed: (){},),
                                        ),
                                        SizedBox(width: 10,),
                            ...
                            Container(height: 430,
                              ...
                              child: GroupedListView<Messages,DateTime>(
                                ...
                                groupHeaderBuilder: (Messages messages) => SizedBox(
                                  height: 40,
                                  // child: Center(child: Card(color: Colors.grey,
