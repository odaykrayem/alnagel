...
import 'package:alnagel/chatting_app/features/chat/widgets/message_reply_preview.dart';
...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void sendTextMessage() async {
    debugPrint('bottom ' + widget.recieverUserId);
    if (isShowSendButton) {
      debugPrint('bottom 2 ' + widget.recieverUserId);
